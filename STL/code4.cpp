...
int main()
{
    ...
    /*
    WHEN TO USE PUSH BACK AND EMPLACE BACK ?
...
//----------Defining a vector of PAIR DATATYPE is also possible----------//

    vector<pair<int, int>> v2;
    v2.push_back({10, 20});
    v2.emplace_back(30, 40); // automtically assumes its a pair so no need of {}
...
//----------USAGE----------//
    ...
    vector<int>::iterator it = vi.begin(); // v.begin points to the memory address // "it" is just a name
